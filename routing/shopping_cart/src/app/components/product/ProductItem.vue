<template>
  <section id="product-item" class="box" v-if="productItem">
    <span class="return-icon" @click="$router.go(-1)"><i class="fa fa-arrow-left is-primary"></i></span>
    <div class="product-item__details">
      ...
      <p class="product-item_created_at">Founded: <span class="has-text-weight-bold">{{ productItem.created_at }}</span></p>
