const InputForm = {
    ...
    <div class="input-form">
      <form @submit="submitForm" class="ui form">
        <div class="field">
          ...
          <span v-if="isNewItemInputLimitExceeded" style="color: red; display: block">Must be under 20 characters</span>
        </div>
        <div class="field">
          <label>Email</label>
  ...
  methods: {
    ...
    validateForm(fields) {
      ...
      if (this.$store.state.fields.email && !this.isEmail(this.$store.state.fields.email)) {
